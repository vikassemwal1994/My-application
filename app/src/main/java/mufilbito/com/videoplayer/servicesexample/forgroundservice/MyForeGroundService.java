package mufilbito.com.videoplayer.servicesexample.forgroundservice;
...
public class MyForeGroundService extends Service {
    ...
    public Notification getNotification(String message) {
        ...
        return new NotificationCompat.Builder(getApplicationContext(), ForegroundServiceActivity.id1)
