package mufilbito.com.videoplayer.createpdf;
...
import mufilbito.com.videoplayer.Utility.PermissionsActivity;
import mufilbito.com.videoplayer.Utility.PermissionsChecker;
import mufilbito.com.videoplayer.createpdf.file.FileUtils;

import static mufilbito.com.videoplayer.createpdf.file.LogUtils.LOGE;
import static mufilbito.com.videoplayer.Utility.PermissionsActivity.PERMISSION_REQUEST_CODE;
import static mufilbito.com.videoplayer.Utility.PermissionsChecker.REQUIRED_PERMISSION;
...
public class CreatePdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_pdf_main);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {
                    PermissionsActivity.startActivityForResult(CreatePdf.this, PERMISSION_REQUEST_CODE
                            , REQUIRED_PERMISSION);
                } else {
                    createPdf(FileUtils.getAppPath(mContext) + "123.pdf");
                }
